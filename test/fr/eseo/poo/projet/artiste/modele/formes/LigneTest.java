...
public class LigneTest {
	...
	public void testConstructeurComplet() {
		...
		assertEquals("Test abscisse du constructeur de Ligne avec cordonnee, largeur et hauteur", 15,
				l1.getC1().getAbscisse(), EPSILON);
		assertEquals("Test ordonnee du constructeur de Ligne avec  crdonnee, largeur et hauteur", -10,
				l1.getC1().getOrdonnee(), EPSILON);
		assertEquals("Test largeur du constructeur de Ligne avec cordonnee, largeur et hauteur", 10, l1.getLargeur(),
				EPSILON);
		assertEquals("Test hauteur du constructeur de Ligne avec cordonnee, largeur et hauteur", 15, l1.getHauteur(),
				EPSILON);
	}
	...
	public void testConstructeurLargeurHauteur() {
		...
		assertEquals("Test abscisse du constructeur de Ligne avec largeur et hauteur", 0, l1.getC1().getAbscisse(),
				EPSILON);
		assertEquals("Test ordonnee du constructeur de Ligne avec largeur et hauteur", 0, l1.getC1().getOrdonnee(),
				EPSILON);
	...
	public void testMutateurs() {
		...
		assertEquals("Test abscisse setter/getter de la 1ere coordonnee de Ligne", -52, l1.getC1().getAbscisse(),
				EPSILON);
		assertEquals("Test ordonnee setter/getter de la 1ere coordonee de Ligne", 12, l1.getC1().getOrdonnee(),
				EPSILON);
		l1.setC2(new Coordonnees(252, 98));
		assertEquals("Test abscisse setter/getter de la 2nde coordonnee de Ligne", 252, l1.getC2().getAbscisse(),
				EPSILON);
		assertEquals("Test ordonnee setter/getter de la 2nde coordonnee de Ligne", 98, l1.getC2().getOrdonnee(),
				EPSILON);
	}
	...
	public void testCadre2() {
		...
		assertEquals("Test point max X du cadre de Ligne avec coordonnee negative de Ligne", 50, l2.getCadreMaxX(),
				EPSILON);
		assertEquals("Test point min X du cadre de Ligne avec coordonnee negative de Ligne", -150, l2.getCadreMinX(),
				EPSILON);
		assertEquals("Test point max Y du cadre de Ligne avec coordonnee negative de Ligne", 200, l2.getCadreMaxY(),
				EPSILON);
		assertEquals("Test point min Y du cadre de Ligne avec coordonnee negative de Ligne", -10, l2.getCadreMinY(),
				EPSILON);
	}
	...
	public void testToStringFR() {
		...
		assertEquals("Test de toString en FR de Ligne",
				"[Ligne] c1 : (85,0 , 50,0) c2 : (95,0 , 65,0) longueur : 18,03 angle : 56,31° couleur = R51,V51,B51",
				l1.toString());
	}
	...
	public void testToStringUK() {
		...
		assertEquals("Test de toString en EN de Ligne",
				"[Ligne] c1 : (85.0 , 50.0) c2 : (95.0 , 65.0) longueur : 18.03 angle : 56.31° couleur = R51,G51,B51",
				l1.toString());
	}
