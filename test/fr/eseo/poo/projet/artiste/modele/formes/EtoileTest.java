...
public class EtoileTest {
	...
	public void testConstructeurTaille() {
		...
		assertEquals("Test nb branche de constructeur avec taille de Etoile", Etoile.NOMBRE_BRANCHES_PAR_DEFAUT,
				e1.getNombreBranches());
		assertEquals("Test longueur branches de constructeur avec taille de Etoile", Etoile.LONGUEUR_BRANCHE_PAR_DEFAUT,
				e1.getLongueurBranche(), EPSILON);
		assertEquals("Test angle de constructeur avec taille de Etoile", Etoile.ANGLE_PREMIERE_BRANCHE_PAR_DEFAUT,
				e1.getAnglePremiereBranche(), EPSILON);
	...
	public void testConstructeurVide() {
		...
		assertEquals("Test largeur de constructeur vide de Etoile", Etoile.LARGEUR_PAR_DEFAUT, e1.getLargeur(),
				EPSILON);
		assertEquals("Test hauteur de constructeur vide de Etoile", Etoile.LARGEUR_PAR_DEFAUT, e1.getHauteur(),
				EPSILON);
		assertEquals("Test nb branches de constructeur vide de Etoile", Etoile.NOMBRE_BRANCHES_PAR_DEFAUT,
				e1.getNombreBranches());
		assertEquals("Test longueur branches de constructeur vide de Etoile", Etoile.LONGUEUR_BRANCHE_PAR_DEFAUT,
				e1.getLongueurBranche(), EPSILON);
		assertEquals("Test angle de constructeur vide de Etoile", Etoile.ANGLE_PREMIERE_BRANCHE_PAR_DEFAUT,
				e1.getAnglePremiereBranche(), EPSILON);
	}
	...
	public void testConstructeurCoordonnee() {
		...
		assertEquals("Test abcisse de constructeur avec coordonnee de Etoile", -14, e1.getPosition().getAbscisse(),
				EPSILON);
		assertEquals("Test ordonnee de constructeur avec coordonnee de Etoile", 63, e1.getPosition().getOrdonnee(),
				EPSILON);
		assertEquals("Test largeur de constructeur avec coordonnee de Etoile", Etoile.LARGEUR_PAR_DEFAUT,
				e1.getLargeur(), EPSILON);
		assertEquals("Test hauteur de constructeur avec coordonnee de Etoile", Etoile.LARGEUR_PAR_DEFAUT,
				e1.getHauteur(), EPSILON);
		assertEquals("Test nb branches de constructeur avec coordonnee de Etoile", Etoile.NOMBRE_BRANCHES_PAR_DEFAUT,
				e1.getNombreBranches());
		assertEquals("Test longueur branches de constructeur avec coordonnee de Etoile",
				Etoile.LONGUEUR_BRANCHE_PAR_DEFAUT, e1.getLongueurBranche(), EPSILON);
		assertEquals("Test angle de constructeur avec coordonnee de Etoile", Etoile.ANGLE_PREMIERE_BRANCHE_PAR_DEFAUT,
				e1.getAnglePremiereBranche(), EPSILON);
	}
	...
	public void testConstructeurCoordonneeLargeur() {
		...
		assertEquals("Test largeur de constructeur avec coordonnee et taille de Etoile", 89,
				e1.getPosition().getAbscisse(), EPSILON);
		assertEquals("Test hauteur de constructeur avec coordonnee et taille de Etoile", 15,
				e1.getPosition().getOrdonnee(), EPSILON);
		assertEquals("Test nb branches de constructeur avec coordonnee et taille de Etoile",
				Etoile.NOMBRE_BRANCHES_PAR_DEFAUT, e1.getNombreBranches());
		assertEquals("Test longueur branches de constructeur avec coordonnee et taille de Etoile",
				Etoile.LONGUEUR_BRANCHE_PAR_DEFAUT, e1.getLongueurBranche(), EPSILON);
		assertEquals("Test angle de constructeur avec coordonnee et taille de Etoile",
				Etoile.ANGLE_PREMIERE_BRANCHE_PAR_DEFAUT, e1.getAnglePremiereBranche(), EPSILON);
	}
	...
	public void testConstructeurComplet() {
		...
		assertEquals(
				"Test abcisse de constructeur avec coordonnee, taille, nb branches, angle, longueur branches de Etoile",
				12, e1.getLargeur(), EPSILON);
		assertEquals(
				"Test ordonnee de constructeur avec coordonnee, taille, nb branches, angle, longueur branches de Etoile",
				12, e1.getHauteur(), EPSILON);
		assertEquals(
				"Test largeur de constructeur avec coordonnee, taille, nb branches, angle, longueur branches de Etoile",
				14, e1.getPosition().getAbscisse(), EPSILON);
		assertEquals(
				"Test hauteur de constructeur avec coordonnee, taille, nb branches, angle, longueur branches de Etoile",
				-47, e1.getPosition().getOrdonnee(), EPSILON);
		assertEquals(
				"Test nb branches de constructeur avec coordonnee, taille, nb branches, angle, longueur branches de Etoile",
				8, e1.getNombreBranches());
		assertEquals(
				"Test longueur branches de constructeur avec coordonnee, taille, nb branches, angle, longueur branches de Etoile",
				0.7, e1.getLongueurBranche(), EPSILON);
		assertEquals(
				"Test angle de constructeur avec coordonnee, taille, nb branches, angle, longueur branches de Etoile",
				0, e1.getAnglePremiereBranche(), EPSILON);
	}
