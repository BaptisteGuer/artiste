...
public class CercleTest {
	...
	public void testConstructeur() {
		...
		assertEquals("Test abscisse du constructeur de Cercle avec coordonee, et largeur", -10,
				c1.getPosition().getOrdonnee(), EPSILON);
		assertEquals("Test ordonnee du constructeur de Cercle avec coordonee, et largeur", 10,
				c1.getPosition().getAbscisse(), EPSILON);
	}
	...
	public void testConstructeurVide() {
		...
		assertEquals("Test largeur du constructeur de Cercle vide", Cercle.LARGEUR_PAR_DEFAUT, c1.getLargeur(),
				EPSILON);
		assertEquals("Test hauteur du constructeur de Cercle vide", Cercle.LARGEUR_PAR_DEFAUT, c1.getHauteur(),
				EPSILON);
	}
	...
	public void testConstructeurOrdonneeAbscisse() {
		...
		assertEquals("Test abscisse du constructeur de Cercle avec coordonnee", -14, c1.getPosition().getAbscisse(),
				EPSILON);
		assertEquals("Test ordonnee du constructeur de Cercle avec coordonnee", 63, c1.getPosition().getOrdonnee(),
				EPSILON);
		assertEquals("Test largeur du constructeur de Cercle avec coordonnee", Cercle.LARGEUR_PAR_DEFAUT,
				c1.getLargeur(), EPSILON);
		assertEquals("Test hauteur du constructeur de Cercle avec coordonnee", Cercle.LARGEUR_PAR_DEFAUT,
				c1.getHauteur(), EPSILON);
	}

	@Test
	public void testConstructeurLargeurHauteur() {
		Cercle c1 = new Cercle(50);
		assertEquals("Test abscisse du constructeur de Cercle avec largeur", 0, c1.getPosition().getAbscisse(),
				EPSILON);
		assertEquals("Test ordonnee du constructeur de Cercle avec largeur", 0, c1.getPosition().getOrdonnee(),
				EPSILON);
